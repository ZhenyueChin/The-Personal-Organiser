...
public class FindFirstName extends JFrame implements Serializable{
	...
	public FindFirstName() {
		super("Find based on the first name");
		...
		final JTextField inputName = new JTextField("Please input the first name here");
		...
		JButton done = new JButton("Done");
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (Person element : persons) {
					if (element.getFirstName().equals(theName)) {
	...
	public static void main(String[] args) {
		FindFirstName launch = new FindFirstName();
