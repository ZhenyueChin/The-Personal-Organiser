...
public class FindFullName extends JFrame implements Serializable{
	...
	public FindFullName() {
		super("Find based on the full name");
		...
		final JTextField inputName = new JTextField("Please input the full name here");
		...
		JButton done = new JButton("Done");
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (Person element : persons) {
					if (element.getFullName().equals(theName)) {
	...
	public static void main(String[] args) {
		FindFullName launch = new FindFullName();
